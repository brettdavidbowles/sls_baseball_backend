...
def play_ball(home_lineup, home_pitcher, away_lineup, away_pitcher):
  ...
  at_bat_list = []
  trys = 0
  while trys < 20 and (scoreboard['half_inning'] < 18 or scoreboard['home_team']['runs'] == scoreboard['away_team']['runs']):
    trys += 1
    ...
    if scoreboard['half_inning'] % 2 == 0:
      away_bats = half_inning(away_lineup, away_place_in_lineup, home_pitcher, scoreboard['away_team']['at_bats'], scoreboard['half_inning'], scoreboard['home_team']['at_bats'])
    ...
    if scoreboard['half_inning'] % 2 == 1 and (scoreboard['half_inning'] < 17 or scoreboard['home_team']['runs'] <= scoreboard['away_team']['runs']):
      home_bats = half_inning(home_lineup, home_place_in_lineup, away_pitcher, scoreboard['home_team']['at_bats'], scoreboard['half_inning'], scoreboard['away_team']['at_bats'])
